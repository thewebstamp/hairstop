...
export default function ProductForm({ product, variants }: ProductFormProps) {
  ...
  }, [selectedLength, selectedColor, variants, product.price]);
    ...
    <div className="bg-linear-to-br from-white to-[#faf9f6]/80 backdrop-blur-sm rounded-2xl border border-white/50 shadow-lg p-6 mb-8">
          ...
          <div className="grid grid-cols-3 sm:grid-cols-4 gap-3">
            {availableLengths.map((length) => (
              <button
                ...
                className={`py-3 border rounded-xl text-center transition-all duration-300 ${selectedLength === length
          ...
          <div className="grid grid-cols-4 sm:grid-cols-6 gap-3">
            {availableColors.map((color) => (
              <button
                ...
                className={`relative p-2 border rounded-xl flex flex-col items-center transition-all duration-300 ${selectedColor === color
      ...
      <div className="space-y-3">
        <button
          ...
          className={`group w-full py-4 rounded-xl font-semibold transition-all duration-300 flex items-center justify-center gap-3 bg-linear-to-r from-[#800020] to-[#b76e79] text-white hover:shadow-xl hover:shadow-[#800020]/30 hover:scale-[1.02] ${isAdding ? 'opacity-75 cursor-wait' : ''}`}
        >
          {isAdding ? (
            <>
        ...
        <button
          ...
          className={`group w-full py-4 border-2 rounded-xl font-semibold transition-all duration-300 flex items-center justify-center gap-3 border-[#800020] text-[#800020] hover:bg-linear-to-r hover:from-[#800020] hover:to-[#b76e79] hover:text-white hover:shadow-xl hover:shadow-[#800020]/30 hover:scale-[1.02]`}
        >
